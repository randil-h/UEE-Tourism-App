...
with_node \
  ...
  --target "/Users/bimidugunathilake/Documents/SE/Projects/UEE-Tourism-App/frontend/ios/Pods/Target Support Files/Pods-frontend/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-sqlite" "expo-system-ui" "expo-web-browser"
